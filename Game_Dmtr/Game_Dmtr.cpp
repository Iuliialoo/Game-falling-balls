...
// Game_Dmtr.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGameDmtrApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CGameDmtrApp::OnAppAbout)
...
// Создание CGameDmtrApp

CGameDmtrApp::CGameDmtrApp() noexcept
{
	...
	SetAppID(_T("GameDmtr.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CGameDmtrApp

CGameDmtrApp theApp;


// Инициализация CGameDmtrApp

BOOL CGameDmtrApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CGameDmtrDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CGameDmtrView));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений CGameDmtrApp
